...
DATABASES = {
    "default": env.db("DATABASE_URL", default="mysql://root")  # 连接mysql数据库
}
DATABASES["default"]["ATOMIC_REQUESTS"] = True  # 将HTTP请求开启事务
...
MIGRATION_MODULES = {"sites": "answerland.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "answerland.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""__YDongY__""", "__ydongy__@example.com")]
...
CELERY_TASK_SERIALIZER = "msgpack"  # 指定接受的内容类型
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "answerland.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "answerland.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
